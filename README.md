...
This project is a full-stack AI-based IT support ticket system.
...
4. Enter issue → Generate Ticket# AI-Powered-Ticket-Creation-and-Categorization-fron-user-input
AI-based IT Ticket Creation and Categorization System using NLP
...
AI-Ticket-System
Public
AI-Powered Ticket Creation and Categorization System

 0 stars  0 forks  Branches  Tags  Activity
Code
Issues
Pull requests
Nithugoud/AI-Ticket-System
Name	
Nithugoud
Nithugoud
last week
...
Preprocessing → unable login company portal error password reset laptop urgent
Entity Extraction → {error_codes: ['0x80070005'], devices: ['laptop']}
Category Prediction → Access (94.5% confidence)
Priority Prediction → High (87.3% confidence)
Output:
...
Include error codes/messages if available
Consider training with more/better quality data
...
TF-IDF + ML Models: Chosen for their balance of simplicity and effectiveness in text classification without needing large datasets.

Pipeline Architecture: Separate modules for preprocessing, prediction, and extraction enable easy maintenance and testing.

Streamlit UI: Provides fast, professional web interface without frontend complexity.

Regex-Based Entity Extraction: Lightweight alternative to NER models, sufficient for IT ticket use case.

JSON Output Format: Industry-standard, easily integrable with other systems.

Session-Based History: Tracks tickets created in current session for quick reference.
...
ML Approach: "The system uses trained ML models instead of hardcoded rules, making it scalable and adaptable to new ticket types."

Pipeline Design: "Clear separation of concerns - preprocessing → prediction → output - makes the code maintainable and testable."

Confidence Scores: "ML models provide probability estimates showing how confident they are in predictions, which is important for decision-making."

Text Preprocessing: "Multiple preprocessing steps (lemmatization, stopword removal, etc.) standardize input and improve model accuracy."

Entity Extraction: "Regex patterns extract structured information like error codes and devices, adding value to tickets."

Production-Ready: "The code uses industry practices - modular design, error handling, configuration management, logging-ready structure."
